...
export default function ResizablePanels({ leftPanel, rightTopPanel, rightBottomPanel }: ResizablePanelsProps) {
    ...
    useEffect(() => {
        ...
        const savedRightTopHeight = localStorage.getItem('pdf-reader-right-top-height');
    ...
    useEffect(() => {
        localStorage.setItem('pdf-reader-right-top-height', rightTopHeight.toString());
    }, [rightTopHeight]);
    ...
    const handleMouseMove = useCallback((e: MouseEvent) => {
        ...
        if (isDraggingHorizontal) {
            ...
            if (rightPanelRect) {
                const newRightTopHeight = ((e.clientY - rightPanelRect.top) / rightPanelRect.height) * 100;
    ...
    useEffect(() => {
        if (isDraggingVertical || isDraggingHorizontal) {
            ...
            document.body.style.cursor = isDraggingVertical ? 'ew-resize' : 'ns-resize';
